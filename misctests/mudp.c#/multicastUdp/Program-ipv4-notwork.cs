...
namespace MulticastUdp
{
    ...
    public class ClientTarget
    {
        ...
        public static void StartMulticastConversation()
        {
            ...
            //var ipendpt = new IPEndPoint(IPAddress.Any, 1000);
            //m_ClientTarget = new UdpClient(ipendpt);

            // Join or create a multicast group
            m_GrpAddr = IPAddress.Parse("239.255.0.13");

            // Use the overloaded JoinMulticastGroup method.   
            // Refer to the ClientOriginator method to see how to use the other  
            // methods.
            //m_ClientTarget.MulticastLoopback = true;
    ...
    public class ClientOriginator
    {
        ...
        public static bool ConnectOriginatorAndTarget()
        {
            try
            {
                ...
                MulticastOption multicastOption = new MulticastOption(m_GrpAddr);

                // Store the IPAdress multicast options.
                IPAddress group = multicastOption.Group;
                int interfaceIndex = multicastOption.InterfaceIndex;

                // Display IPv6MulticastOption properties.
                Console.WriteLine("MulticastOption.Group: [" + group + "]");
                Console.WriteLine("MulticastOption.InterfaceIndex: [" + interfaceIndex + "]");



                // Instantiate IPv6MulticastOption using another  
                // overloaded constructor.
                MulticastOption multicastOption2 = new MulticastOption(group, interfaceIndex);

                // Store the IPAdress multicast options. 
                group = multicastOption2.Group;
                interfaceIndex = multicastOption2.InterfaceIndex;
                ...
                clientOriginator.JoinMulticastGroup(interfaceIndex, group);
